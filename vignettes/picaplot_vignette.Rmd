...
- ```expr_data``` = gene expression measurements for 26391 probes and 47 samples. (2642 probes if loaded from package)

- ```sample_info``` = 5 covariates for each sample 

- ```probe_info``` = positional information for 26391 probes (2642 probes if loaded from package)
...
pc1_plot = plot_component(pca_object, 
                          comp_idx = 1)

ic1_plot = plot_component(ica_object,
                          comp_idx = 1)
...
pc1_color = plot_component(pca_object, 
                           comp_idx = 1, 
                           geneinfo_df = probe_info)

ic1_color = plot_component(ica_object, 
                           comp_idx = 1, 
                           geneinfo_df = probe_info)
